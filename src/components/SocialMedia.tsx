...
export default function SocialMedia() {
  return (
    <div className='max-w-[990px] mx-auto block w-full xs:py-14 py-8 px-4' >
...
<div className='grid xs:grid-cols-3  mini:grid-cols-2 grid-cols-1 mini:max-w-[100%] max-w-[80%] gap-6 mx-auto mini:gap-6'>

<div className=''>
<Link href = "https://www.instagram.com/anike_teee?igsh=YnJ1ZmVoZmVhaThp&utm_source=qr" className="w-full">
<Image src={Img1} className='w-[100%] mx-auto rounded-lg h-full object-fill object-[0px_30%]' width={200} height={200} alt='' />
</Link>
</div>
<div className=''>
<Link href = "https://www.instagram.com/crestville_apartments/" className="w-full">
<Image src={Img2} className='w-[100%] mx-auto rounded-lg h-full object-fill object-[0px_30%]' width={200} height={200} alt='' />
</Link>
</div>

<div className=''>
<Link href = "https://www.tiktok.com/@crestville.apartm?_t=ZM-8ttQBdxnwPv&_r=1" className="w-full">
<Image src={Img3} className='w-[100%] mx-auto rounded-lg h-full object-fill object-[0px_30%]' width={200} height={200} alt='' />
</Link>
</div>
